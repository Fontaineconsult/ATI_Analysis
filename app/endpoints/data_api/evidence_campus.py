...
class EvidenceAPI(MethodView):
    ...
    def handle_withdraw_approval(self, data):
        ...
        approving). Clears the complete flag/date and the completed-by edge; the
        ready flag is untouched, so the evidence returns to awaiting approval.

            {"action": "withdraw_approval",
             "year_success_evidence": "2025-2026-7.11-ins-sfsu",
             "employee_id": "912345678"}
        """
