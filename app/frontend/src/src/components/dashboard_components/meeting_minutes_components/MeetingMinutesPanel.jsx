...
function MinutesRow({ minutes, onChanged, onEdit }) {
    ...
    return (
        <Box borderWidth="1px" borderColor="gray.200" borderRadius="md" borderLeftWidth="3px" borderLeftColor="teal.400" bg="white" overflow="hidden">
            <Flex align="center" gap={2} p={2} bg="gray.50" cursor="pointer" onClick={onToggle} _hover={{ bg: 'gray.100' }} role="button" aria-expanded={isOpen}>
