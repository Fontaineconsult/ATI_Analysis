...
// Custom hook to access the shared meta-scaffold store (SchemaElements, Principles,
// IntellectualSources) + its handle/id lookup helpers + reload().
//
// Example:
//   const { principles, loading, reload, getSchemaElement } = useMetaScaffold();
