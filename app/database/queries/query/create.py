...
from app.data_config import query_categories, working_group_code_by_token
...
# normalized to the 3-letter code used in WorkingGroupPlan.plan_identifier. Derived
# from the single source of truth (data_config.WORKING_GROUP_DEFS).
